defmodule Loka.Accounts.Player do
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Loka.Repo)
  ...
  """
  def valid_password?(%Loka.Accounts.Player{hashed_password: hashed_password}, password)
  ...
  @doc """
  A player changeset for guest registration via device ID.
  """
  def guest_changeset(player, attrs) do
    player
    |> cast(attrs, [:device_id, :name])
  ...
  @doc """
  A player changeset for updating the player's display name.
  """
