defmodule Loka.Framework.Crafting.Recipe do
  @moduledoc """
  ...
  @type resource_costs :: %{atom() => non_neg_integer()}
  ...
  def from_map(data) when is_map(data) do
    with {:ok, key} <- require_field(data, :key),
      ...
      recipe = %__MODULE__{
        ...
        resource_costs: parse_resource_costs(data),
  ...
  defp parse_resource_costs(data) do
    costs = MapHelpers.get_flexible(data, :resource_costs, %{})

    # Convert string keys to atoms for consistency with Cost mechanic
