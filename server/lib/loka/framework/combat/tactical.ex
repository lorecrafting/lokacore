defmodule Loka.Framework.Combat.Tactical do
  @moduledoc """
  ...
  the core `Loka.Framework.Combat` module:
  ...
  @config_table :loka_combat_config
  ...
  # sobelow_skip ["DOS.StringToAtom"] - actions from internal YAML config files
