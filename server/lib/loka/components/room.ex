defmodule Loka.Components.Room do
  @moduledoc "Typed access to the `room` component (spawns config)."
  ...
  def spawns(entity), do: get_in(entity.components, [@component_key, "spawns"]) || []
end
