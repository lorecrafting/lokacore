defmodule Loka.Components.Skills do
  @moduledoc "Typed access to the `skills` component (learned skill list)."
  ...
  def learned(entity), do: get_in(entity.components, [@component_key, "learned"]) || []
end
