defmodule Loka.Components.Service do
  @moduledoc "Typed access to the `service` component (boot_priority for system entities)."
  ...
  def boot_priority(entity),
    do: get_in(entity.components, [@component_key, "boot_priority"]) || 100
end
