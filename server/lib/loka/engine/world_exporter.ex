defmodule Loka.Engine.WorldExporter do
  @moduledoc """
  ...
  # sobelow_skip ["Traversal.FileModule"] - output_dir admin-provided, filename sanitized
  ...
  # sobelow_skip ["Traversal.FileModule"] - output_dir from admin functions, not user input
