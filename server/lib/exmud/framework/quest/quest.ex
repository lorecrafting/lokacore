defmodule Exmud.Framework.Quest do
  @moduledoc """
  Quest management system for the game framework.

  This module delegates to specialized modules:
  - `Exmud.Framework.Quest.Definitions` - Quest/Objective structs and loading
  - `Exmud.Framework.Quest.Progress` - Player quest progress tracking
