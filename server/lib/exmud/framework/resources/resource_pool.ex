defmodule Exmud.Framework.Resources.ResourcePool do
  @moduledoc """
  ...
  ## Usage
      ...
      alias Exmud.Framework.Resources.ResourcePool
  ...
  alias Exmud.Framework.Resources.{Resource, ResourceRegistry, FormulaEvaluator}

  @pool_table :exmud_resource_pools
