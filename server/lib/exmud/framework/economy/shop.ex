defmodule Exmud.Framework.Economy.Shop do
  @moduledoc """
  ...
  ## Usage
      ...
      case Shop.get_shop(npc_entity) do
        nil -> "This NPC is not a merchant"
  ...
  def get_shop(npc_entity) do
    ...
    merchant_data = MapHelpers.get_flexible(components, :merchant, nil)

    case merchant_data do
      nil -> nil
  ...
  defp parse_stock(data) do
    stock = MapHelpers.get_flexible(data, :stock, [])
  ...
  """
  def get_sell_price(npc_entity, item_key, base_price, quantity \\ 1) do
    _ = item_key
