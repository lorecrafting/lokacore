defmodule Exmud.Framework.World.ExtendedDescriptions do
  @moduledoc """
  ...
  ## Usage
      ...
      alias Exmud.Framework.World.ExtendedDescriptions
  ...
  defp get_weather_variant(ext_desc, context) do
    ...
    weather_atom = if is_atom(weather), do: weather, else: String.to_atom(weather)
    Map.get(ext_desc.weather_variants, weather_atom)
  end
