defmodule Exmud.Framework.Combat.DamageTypes do
  @moduledoc """
  ...
  ## Usage
      ...
      alias Exmud.Framework.Combat.DamageTypes
  ...
  @damage_types_table :exmud_damage_types
  @armor_types_table :exmud_armor_types
