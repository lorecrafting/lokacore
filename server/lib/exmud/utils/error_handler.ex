defmodule Exmud.Utils.ErrorHandler do
  @moduledoc """
  Unified error handling for ExMUD game actions.

  Provides consistent error atoms and user-friendly messages for game errors.

  ## Usage

      alias Exmud.Utils.ErrorHandler
  ...
  - Combat errors: `:not_combatant`, `:not_player_turn`, `:invalid_action`
  ...
  def message(:inventory_full), do: "Your inventory is full."
  ...
  def message(:not_player_turn), do: "It's not your turn."
  def message(:not_enemy_turn), do: "It's not their turn."
