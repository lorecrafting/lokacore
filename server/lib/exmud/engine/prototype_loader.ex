defmodule Exmud.Engine.PrototypeLoader do
  @moduledoc """
  ...
  @prototype_table :exmud_prototypes
  ...
  defp do_topological_sort(remaining, raw, sorted, visited) do
    ...
    cond do
      ...
      Enum.empty?(ready) ->
        ...
        # Add them at the end anyway (they'll be loaded without parent resolution)
  ...
  defp update_ets(table, resolved_prototypes) do
    ...
    # Insert all resolved prototypes
