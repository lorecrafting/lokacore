defmodule Exmud.Engine.WorldGraph do
  @moduledoc """
  ...
  alias Exmud.Engine.{Entities, Entity}
  ...
  """
  def direction_offsets, do: @direction_offsets
  ...
  ## Examples
      ...
      nil
  """
  def direction_offset(direction) when is_binary(direction) do
    Map.get(@direction_offsets, String.downcase(direction))
  end

  def direction_offset(direction) when is_atom(direction) do
    direction_offset(to_string(direction))
  end
  ...
  ## Examples
      ...
      "east"
  """
  def infer_direction({x1, y1, z1}, {x2, y2, z2}) do
    dx = x2 - x1
    dy = y2 - y1
    dz = z2 - z1
    ...
    cond do
      ...
      dy < 0 and dx == 0 -> "north"
      dy > 0 and dx == 0 -> "south"
      dx > 0 and dy < 0 -> "northeast"
      dx < 0 and dy < 0 -> "northwest"
      dx > 0 and dy > 0 -> "southeast"
      dx < 0 and dy > 0 -> "southwest"
      true -> nil
    end
  end
end
