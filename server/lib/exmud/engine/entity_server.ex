defmodule Exmud.Engine.EntityServer do
  @moduledoc """
  ...
  alias Exmud.Engine.{Entities, Entity, EventBus}
  ...
  # 2 minutes
  @default_hibernate_after_ms 120_000
  ...
  def handle_cast({:event, event}, state) do
    # TODO: Run entity's behaviors on event when Behavior module is implemented
    # For now, just log and mark as dirty if the entity was affected
  ...
  defp save_if_dirty(%{dirty: true} = state) do
    case Entities.save_entity(state.entity) do
      {:ok, _} ->
