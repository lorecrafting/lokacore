defmodule Exmud.Session.Registry do
  @moduledoc """
  ...
  1. **Player Registry** (`Exmud.Session.PlayerRegistry`)
  ...
  @room_index :exmud_session_room_index
  ...
  def list_sessions do
    Registry.select(Exmud.Session.PlayerRegistry, [
      {{:"$1", :"$2", :"$3"}, [], [{{:"$1", :"$2", :"$3"}}]}
    ])
  end
  ...
  def online_count do
    Registry.count(Exmud.Session.PlayerRegistry)
  end
