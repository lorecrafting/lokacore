...
if existing_oak do
  ...
  {:ok, _combat_trainer} =
    Entities.create_entity(%{
      ...
      components: %{
        ...
        "dialogue_tree" => %{
          "start" => %{
            "text" => "Greetings, warrior. I've trained many fighters in my time. If you have skill points to spend, I can teach you the ways of combat.",
            "choices" => [
              %{"text" => "Teach me Power Strike (2 SP)", "next" => "learn_power_strike", "action" => ["learn_skill", "power_strike", 2]},
              %{"text" => "Teach me Critical Eye (3 SP)", "next" => "learn_critical_eye", "action" => ["learn_skill", "critical_eye", 3]},
              %{"text" => "Teach me Berserker Rage (4 SP)", "next" => "learn_berserker_rage", "action" => ["learn_skill", "berserker_rage", 4]},
              %{"text" => "Perhaps another time.", "next" => "farewell"}
            ]
          },
          "learn_power_strike" => %{
            "text" => "Power Strike. A simple but effective technique. Put your whole body behind the blow, not just your arm.",
            "choices" => [
          ...
          "learn_critical_eye" => %{
            "text" => "Ah, the Critical Eye. Learn to spot your enemy's weaknesses. Strike where they are most vulnerable.",
            "choices" => [
              %{"text" => "What else can you teach me?", "next" => "start"},
              %{"text" => "Thank you.", "next" => "farewell"}
            ]
          ...
          "learn_berserker_rage" => %{
            "text" => "Berserker Rage is dangerous. You sacrifice defense for overwhelming offense. Use it wisely.",
            "choices" => [
              %{"text" => "What else can you teach me?", "next" => "start"},
              %{"text" => "Thank you.", "next" => "farewell"}
            ]
  ...
  {:ok, _defense_trainer} =
    Entities.create_entity(%{
      ...
      components: %{
        ...
        "dialogue_tree" => %{
          "start" => %{
            "text" => "The best warriors are those who live to fight another day. I can teach you the art of defense, if you have skill points to spend.",
            "choices" => [
              %{"text" => "Teach me Shield Wall (2 SP)", "next" => "learn_shield_wall", "action" => ["learn_skill", "shield_wall", 2]},
              %{"text" => "Teach me Parry (3 SP)", "next" => "learn_parry", "action" => ["learn_skill", "parry", 3]},
              %{"text" => "Teach me Fortitude (4 SP)", "next" => "learn_fortitude", "action" => ["learn_skill", "fortitude", 4]},
              %{"text" => "Perhaps another time.", "next" => "farewell"}
            ]
          },
          "learn_shield_wall" => %{
            "text" => "Shield Wall. Plant your feet, raise your shield, and become an immovable object.",
            "choices" => [
              %{"text" => "What else can you teach me?", "next" => "start"},
              %{"text" => "Thank you.", "next" => "farewell"}
            ]
          ...
          "learn_parry" => %{
            "text" => "To parry is to redirect force. Let your enemy's strength become their weakness.",
            "choices" => [
              %{"text" => "What else can you teach me?", "next" => "start"},
              %{"text" => "Thank you.", "next" => "farewell"}
            ]
          ...
          "learn_fortitude" => %{
            "text" => "Fortitude comes from within. Strengthen your body, strengthen your spirit.",
            "choices" => [
              %{"text" => "What else can you teach me?", "next" => "start"},
              %{"text" => "Thank you.", "next" => "farewell"}
            ]
  ...
  {:ok, _} =
    Scripts.create_script(%{
      ...
      description: "Makes an NPC greet players when they enter the room. Demonstrates on_enter hook and game.message API.",
      hook: "on_enter",
      enabled: true,
      source: ~S"""
-- NPC Greeting Script
...
"""
  ...
  {:ok, _} =
    Scripts.create_script(%{
      ...
      description: "A spike trap that damages players. Demonstrates conditional logic and health modification.",
      hook: "on_enter",
      enabled: true,
      source: ~S"""
-- Spike Trap Script
...
"""
  ...
  {:ok, _} =
    Scripts.create_script(%{
      ...
      description: "A healing potion that restores health. Demonstrates on_use hook and player stat modification.",
      hook: "on_use",
      enabled: true,
      source: ~S"""
...
"""
  ...
  {:ok, _} =
    Scripts.create_script(%{
      ...
      description: "Makes an NPC patrol between waypoints. Demonstrates on_tick hook and movement logic.",
      hook: "on_tick",
      enabled: true,
      source: ~S"""
-- NPC Patrol Script
...
"""
  ...
  {:ok, _} =
    Scripts.create_script(%{
      ...
      description: "Tracks quest objective completion. Demonstrates custom hook for quest events.",
      hook: "custom",
      enabled: true,
      source: ~S"""
...
"""
  ...
  {:ok, _} =
    Scripts.create_script(%{
      ...
      description: "Handles combat attack calculations. Demonstrates on_attack hook and damage formulas.",
      hook: "on_attack",
      enabled: true,
      source: ~S"""
...
"""
  ...
  {:ok, _} =
    Scripts.create_script(%{
      ...
      description: "Modifies room description based on time of day. Demonstrates on_look hook with context data.",
      hook: "on_look",
      enabled: true,
      source: ~S"""
...
"""
  ...
  {:ok, _} =
    Scripts.create_script(%{
      ...
      description: "A lever that can be pulled to trigger effects. Demonstrates on_use with state tracking.",
      hook: "on_use",
      enabled: true,
      source: ~S"""
