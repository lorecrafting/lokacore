defmodule Loka.Engine.PrototypeTest do
  ...
  describe "new/1" do
    ...
    test "creates a valid prototype from map with atom keys" do
      assert {:ok, proto} = Prototype.new(%{key: "goblin", type: :npc, short_desc: "Goblin"})
      assert proto.key == "goblin"
      assert proto.type == :npc
      assert proto.short_desc == "Goblin"
    end
    ...
    test "creates prototype with all fields" do
      attrs = %{
        ...
        parent: "base_npc",
        type: :npc,
        short_desc: "Goblin Warrior",
        long_desc: "A fierce goblin warrior stands here.",
        extra_desc: "A fierce goblin.",
        keywords: ["goblin", "warrior"],
        components: %{"combatant" => %{"health" => 30}},
        behaviors: [Loka.Engine.PrototypeTest],
  ...
  describe "merge_parent/2" do
    test "child key overrides parent key" do
      parent = %Prototype{key: "base", type: :npc, short_desc: "Base NPC"}
    ...
    test "child short_desc overrides parent short_desc" do
      parent = %Prototype{key: "base", type: :npc, short_desc: "Base NPC"}
      child = %Prototype{key: "goblin", type: :npc, short_desc: "Goblin"}

      merged = Prototype.merge_parent(child, parent)

      assert merged.short_desc == "Goblin"
    end

    test "inherits parent short_desc if child has none" do
      parent = %Prototype{key: "base", type: :npc, short_desc: "Base NPC"}
      child = %Prototype{key: "goblin", type: :npc}

      merged = Prototype.merge_parent(child, parent)

      assert merged.short_desc == "Base NPC"
    end
  ...
  describe "to_entity/2" do
    test "converts prototype to entity with new UUID" do
      {:ok, proto} = Prototype.new(key: "goblin", type: :npc, short_desc: "Goblin")
    ...
    test "copies all fields to entity" do
      {:ok, proto} =
        Prototype.new(
          ...
          type: :npc,
          short_desc: "Goblin",
          long_desc: "A goblin stands here.",
          extra_desc: "A goblin",
          keywords: ["goblin"],
      ...
      assert entity.extra_desc == "A goblin"
    ...
    test "applies overrides" do
      ...
      entity = Prototype.to_entity(proto, %{short_desc: "Elite Goblin", location_id: "room_1"})
