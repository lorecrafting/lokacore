defmodule Loka.Engine.WorldExporterTest do
  ...
  setup do
    ...
    export_dir = Path.join(System.tmp_dir!(), "loka_export_test_#{:rand.uniform(10000)}")
  ...
  describe "entity_to_prototype/1" do
    test "converts entity to prototype map" do
      entity = %Entity{
        ...
        long_desc: "A test item sits here.",
        extra_desc: "A test item",
        keywords: ["test", "item"],
      ...
      assert proto["short_desc"] == "Test Item"
      assert proto["extra_desc"] == "A test item"
  ...
  describe "entity_to_yaml/1" do
    test "produces valid YAML string" do
      ...
      assert String.contains?(yaml, "short_desc: Test Item")
    end
    ...
    test "handles multiline descriptions" do
      ...
      assert String.contains?(yaml, "extra_desc: |")
    end
  end
