defmodule Exmud.Framework.Status.StatusRegistryTest do
  use ExUnit.Case, async: false

  alias Exmud.Framework.Status.{StatusRegistry, StatusEffect}
  ...
  setup %{temp_dir: temp_dir} do
    ...
    {:ok, _pid} = start_supervised({StatusRegistry, name: StatusRegistry, path: temp_dir})
    :ok
  end
