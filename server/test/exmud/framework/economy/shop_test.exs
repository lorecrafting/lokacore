defmodule Exmud.Framework.Economy.ShopTest do
  use Exmud.DataCase
  ...
  defp create_merchant(attrs \\ %{}) do
    ...
    {:ok, entity} =
      Exmud.Engine.Entities.create_entity(%{
        ...
        type: "npc",
        components: %{"merchant" => merchant_component},
  ...
  describe "list_stock/2" do
    ...
    test "returns empty list when no stock available" do
      merchant = create_merchant(%{merchant: %{stock: []}})
  ...
  describe "edge cases" do
    test "handles empty merchant component" do
      merchant = create_merchant(%{merchant: %{}})
      shop = Shop.get_shop(merchant)
