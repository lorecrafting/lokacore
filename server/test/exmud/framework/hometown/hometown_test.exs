defmodule Exmud.Framework.HometownTest do
  use Exmud.DataCase

  alias Exmud.Framework.Hometown
  ...
  setup do
    # Start a hometown server for each test with fixture path
    {:ok, pid} = start_supervised({Hometown, path: @fixtures_path, name: :test_hometown_server})
    %{hometown_server: pid}
  end
