defmodule Exmud.Framework.GatheringTest do
  use Exmud.DataCase
  ...
  setup do
    # Start the GatheringRegistry GenServer for tests
    # Use the default name since Gathering module calls GatheringRegistry without server param
    {:ok, registry_pid} = start_supervised({GatheringRegistry, [load_on_start: false]})
