defmodule Exmud.Framework.Skills.SkillManagerTest do
  use Exmud.DataCase, async: false

  alias Exmud.Framework.Skills.{Skill, SkillManager, SkillRegistry}
  alias Exmud.Framework.Player.GameState

  import Exmud.AccountsFixtures

  setup do
    # Start the SkillRegistry for tests
    {:ok, _registry} = start_supervised({SkillRegistry, [load_on_start: false]})
