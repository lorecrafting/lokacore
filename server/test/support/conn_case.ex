defmodule LokaWeb.ConnCase do
  ...
  def register_and_log_in_player(%{conn: conn} = context) do
    player = Loka.AccountsFixtures.player_fixture()
  ...
  def log_in_player(conn, player, opts \\ []) do
    token = Loka.Accounts.generate_player_session_token(player)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Loka.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
