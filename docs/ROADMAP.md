...
| Early R7/R8 | 5 | one quest, a dialogue choice, a schedule, reactions, narration (TypeScript); carried from R5 (Gate R5 reports them as deferred, not missing): keys that break on a failed force and locked containers from 00 §4.4 (the door commands gain an optional target), a policy leaf reading resources, positions and their regeneration bonuses |
