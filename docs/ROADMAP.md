...
| Early R7/R8 | 5 | one quest, a dialogue choice, a schedule, reactions, narration (TypeScript); carried from R5: keys that break on a failed force and locked containers (the door commands gain an optional target), a policy leaf reading resources, positions and their regeneration bonuses |
