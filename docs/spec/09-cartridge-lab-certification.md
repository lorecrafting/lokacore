...
*Amendment 2026-09-25 ([ADR-075](../decisions/adr-075-observability-proposal.md)):* the stored game trace keeps a state delta digest (ADR-075 §4); the viewer derives per-component diffs by deterministic replay.
