...
The detailed runnable handoff is [r1-work-package.md](https://github.com/lorecrafting/lokacore-v2-legacy/blob/997a7a8/docs/rewrite-v3/r1-work-package.md). It is subordinate to this plan and the envelope. New document headings do not create new top-level R IDs. R3A freezes constitutional schemas; R3B/feature schemas still wait for implementation evidence at the relevant slices.
