...
- [S4 owner answers, touch-link ruling, #38-#40 ledger](2026-09-25-pm-docs-s4-answers-review.md): PR #41 at `943c44a`, APPROVE WITH NOTES (three should-fix: `fact_changed` timing, touch links against the Text/GameView contracts, the link compile rule against existing content).
