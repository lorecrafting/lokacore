...
- [Observability design: ADR-075 and observation contracts](2026-09-25-observability-design-review.md): PR #29 at `fd0ab9f`, APPROVE WITH NOTES; Astra relay; fixes `59b55e2` (head `e2847af`), APPROVE WITH NOTES.
