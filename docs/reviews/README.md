...
- [R5 S8: `scan` (movement@1), loader touch-link parity, `implemented_in` held to the code, mobile require/jest lint](2026-09-26-r5-s8-review.md): PR #52 at `870cca1`, APPROVE WITH NOTES (one nit: the jest list misses `setMock` and `createMockFromModule`).
