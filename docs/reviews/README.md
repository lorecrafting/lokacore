...
- [R5 S6b: resources (HP/MA/MV), costs, threshold checks, cooldowns, 1 MV per move, regeneration](2026-09-25-r5-s6b-review.md): PR #49 at `7cb4af2`, APPROVE WITH NOTES (two should-fix: an over-maximum `resource.adjust` step faults in ordinary play with no author guard; a long cooldown overflows into `evaluator_error`).
