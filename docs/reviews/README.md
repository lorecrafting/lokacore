...
- [R5 S4: take/drop/give, containment checks, item text, touch links, `fact_changed`, fact typing](2026-09-25-r5-s4-review.md): PR #42 at `7938da9`, APPROVE WITH NOTES (two should-fix: `fact_changed` position, `has_item` semantics in the contract).
